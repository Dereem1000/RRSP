...
module.exports = {
  ...
  {
    name: 'ms-cabb6ce6-zenlaw-server',
    ...
    env: {
      ...
      CORS_ORIGINS: 'http://localhost:8100,http://127.0.0.1:8100,https://www.computerdynamicstt.com,http://www.computerdynamicstt.com',
  ...
  {
    name: 'ms-cabb6ce6-rotation-scheduler',
    script: './workstation-monitor/rotation_scheduler.py',
    cwd: '.',
    instances: 1,
    exec_mode: 'fork',
    interpreter: "C:/Users/User/AppData/Local/Programs/Python/Python313/python.exe",
    env: {
      ...
      ROTATION_API_URL: 'http://localhost:8100/api',
